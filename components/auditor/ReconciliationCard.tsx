...
const METHODS: {
...
}[] = [
  {
    key: "cash",
    label: "نقدي",
    inputLabel: "المبلغ النقدي المُبلَّغ عنه (ج.م)",
    Icon: Banknote,
  ...
  },
  {
    key: "instapay",
    label: "إنستاباي",
    inputLabel: "إجمالي إنستاباي المُبلَّغ عنه (ج.م)",
    Icon: Smartphone,
  ...
  },
  {
    key: "fawry",
    label: "فوري",
    inputLabel: "إجمالي فوري المُبلَّغ عنه (ج.م)",
    Icon: CreditCard,
  ...
  },
  {
    key: "insurance",
    label: "تأمين",
    inputLabel: "إجمالي التأمين المُحصَّل (ج.م)",
    Icon: Shield,
